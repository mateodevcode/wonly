...
const Articulo = () => {
  return (
    <div className="w-full h-full flex flex-col justify-start items-center bg-black pt-16">
      ...
      <div className="lg:w-full md:w-9/12 sm:w-full h-full flex flex-row py-10 bg-gray-100">
        <div className="w-full grid grid-cols-1 gap-1 place-content-start place-items-center lg:p-0 md:p-2 sm:p-2 border-t-2 border-gray-400">
