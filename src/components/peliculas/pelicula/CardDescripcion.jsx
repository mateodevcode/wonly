...
const CardDescripcion = ({ titulo, duracion, descripcion }) => {
  return (
    <div className="lg:w-[950px] md:w-[800px] sm:w-full flex flex-col justify-center items-start lg:mb-20 md:mb-20 sm:mb-5 lg:mt-2 md:mt-2 sm:mt-0 lg:px-0 md:px-5 sm:px-5">
