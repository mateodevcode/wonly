...
const CardDescripcion = ({ titulo, duracion, descripcion, temporada, episodio }) => {
  return (
    <div className="xl:w-[1440px] lg:w-[950px] md:w-full sm:w-full flex flex-col justify-center items-start lg:mb-20 md:mb-20 sm:mb-5 lg:mt-2 md:mt-2 sm:mt-0 px-5">
