...
const CardDescripcion = ({titulo, duracion, descripcion}) => {
  return (
    <div className="lg:w-[800px] md:w-[800px] sm:w-full flex flex-col justify-center items-start lg:mb-20 md:mb-20 sm:mb-5 lg:mt-2 md:mt-2 sm:mt-0 lg:px-8 md:px-8 sm:px-2">
      ...
      <p className="lg:text-base md:text-base sm:text-xs dark:text-white mt-2">{descripcion}</p>
    </div>
  );
};
