  ...
  return (
    <div className="w-full bg-black pt-20">
      <div className="w-full flex flex-col justify-between items-center">
        <div className="w-full flex lg:flex-row sm:flex-col justify-between items-start lg:px-10 sm:px-2 text-white text-xl font-mono text-center">
          <Tops />
          <Link
            href={"/"}
            className="flex flex-col justify-center items-center lg:h-60 sm:h-44 lg:w-4/12 sm:w-full"
          >
            <Image
              src={logo.src}
              width={800}
