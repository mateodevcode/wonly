...
const Formulario = ({ setNombre, setEmail, setTipo, onClose, handlePeticiones, tipo }) => {
  ...
  return (
    <div className="lg:w-[450px] md:w-[450px] smd:w-[450px] sm:w-[95%] bg-white h-min lg:mt-24 md:mt-24 sm:mt-20 rounded-lg border-[1px] border-gray-600">
      <div className="flex flex-col justify-start items-start px-5 pt-5">
        ...
        <div className="w-full mt-4 mb-4">
          <p className="text-sm text-black font-semibold">Tipo de contenido</p>
          <div className="flex flex-row justify-between items-center w-full text-black my-2">
            <button className={`flex flex-col justify-center items-center border-2 rounded-md py-2 px-5 mr-1 w-6/12 cursor-pointer select-none ${tipo === "pelicula" ? "border-blue-500 bg-blue-500/20" : "border-black"}`} id="pelicula" onClick={(e) => setTipo(e.target.id)
            }>
            ...
            <button className={`flex flex-col justify-center items-center border-2 rounded-md py-2 px-5 mr-1 w-6/12 cursor-pointer select-none ${tipo === "serie" ? "border-blue-500 bg-blue-500/20" : "border-black"}`} id="serie" onClick={(e) => setTipo(e.target.id)
            }>
        ...
        <InputGroup className="flex flex-row justify-center items-center">
          <Input
            ...
            className="w-full px-4 py-2 rounded-md text-black text-sm border-[1px] border-gray-500 my-2"
          />
        </InputGroup>
        </div>
        <div className="w-full">
        ...
        <div className="flex flex-row justify-between items-center w-full my-5">
          <div
            className="flex flex-row justify-center items-center bg-black text-white px-3 py-1.5 rounded-md cursor-pointer hover:bg-black/85 select-none mx-1"
            onClick={onClose}
          >
          Salir
          </div>
